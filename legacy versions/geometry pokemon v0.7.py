...
MAX_JUMP_STRENGTH = 45  # Maximum jump strength is now 45
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                # X key now works regardless of being on ground:
            ...
            if event.type == pygame.JOYBUTTONDOWN:
                ...
                if event.button == 0:
                    ...
                    if player.on_ground:
                        player.charging = True
                        player.jump_charge = MIN_JUMP_STRENGTH
                # X button (button 2) now works always:
                if event.button == 2:
                    print("Joystick button X pressed")
                    boing_sound.play()
                    if player.on_ground:
                        player.vel_y = -MIN_JUMP_STRENGTH
                    elif not player.on_ground and player.can_double_jump:
        ...
        # End-level and game-over handling below...
